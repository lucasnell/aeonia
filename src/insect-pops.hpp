...
// public:
//
//     OldAphidPops(const double& surv_j,
//               const double& surv_a,
...
//     };
//
//     OldAphidPops(const OldAphidPops& other)
...
//
//     /*
//      Set pseudo_surv, which is useful for using a single OldAphidPops to populate a vector
...
//     }
//     /*
//      Set K, which is useful for using a single OldAphidPops to populate a vector
...
//     void set_parameters(const OldAphidPops& other) {
//
//         L = other.L;
//         K = other.K;
//         K_p = other.K_p;
...
//                 const OldAphidPops& aphids_xy(plants[x][y].aphids);
