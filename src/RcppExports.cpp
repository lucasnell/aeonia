...
// sim_plantscape
DataFrame sim_plantscape(const arma::ucube& landscapes, const uint32& max_t, SEXP insect_ptr, const arma::cube& N0, const arma::cube& W0, const arma::cube& Y0, const double& alpha, const double& beta, const double& epsilon, const double& delta_a, const double& delta_p, const uint32& total_exp_days, const double& w, const double& radius, Nullable<NumericMatrix> wasp_plant_attract, const std::string& summ, const bool& infect_stop, const bool& out_pseudo, const bool& show_progress, uint32 n_threads);
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(sim_plantscape(landscapes, max_t, insect_ptr, N0, W0, Y0, alpha, beta, epsilon, delta_a, delta_p, total_exp_days, w, radius, wasp_plant_attract, summ, infect_stop, out_pseudo, show_progress, n_threads));
    return rcpp_result_gen;
END_RCPP
}
// sim_plant_types
