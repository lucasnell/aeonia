...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(sim_plantscape(landscapes, max_t, insect_ptr, N0, W0, Y0, virus_attract, pseudo_repel, epsilon, p_load_alate, p_load_plant, total_exp_days, w, radius, wasp_plant_attract, summ, infect_time_n, aphid_gone_thresh, wasp_gone_thresh, infect_stop, out_pseudo, out_stages, out_dispersals, show_progress, n_threads));
    return rcpp_result_gen;
END_RCPP
}
// sim_plant_types
