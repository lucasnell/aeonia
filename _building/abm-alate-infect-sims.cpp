...
//'
//[[Rcpp::export]]
DataFrame alate_infect_sims(const int& x_size,
                            const int& y_size,
                            const double& delta_a,
                            const double& delta_p,
                            const std::vector<int>& land,
    ...
    DataFrame out_df = DataFrame::create(_["land"] = arma::regspace<arma::ivec>(1, n_lands),
                                         _["a_inoc"] = inocs.col(0),
                                         _["p_inoc"] = inocs.col(1));
