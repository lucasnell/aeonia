...
make_aphid_ptr <- function(K, K_p, pseudo_surv, pred_surv, extinct_N, demog_error, sigma_x, rho, fly_p, attack_surv, aphid_name, leslie_mat, aphid_density_0, alate_b0, alate_b1, adult_age, living_days) {
    .Call(`_aeonia_make_aphid_ptr`, K, K_p, pseudo_surv, pred_surv, extinct_N, demog_error, sigma_x, rho, fly_p, attack_surv, aphid_name, leslie_mat, aphid_density_0, alate_b0, alate_b1, adult_age, living_days)
}
...
make_insect_ptr_cpp <- function(aphids_xptr, wasps_xptr, mummies_xptr) {
    .Call(`_aeonia_make_insect_ptr_cpp`, aphids_xptr, wasps_xptr, mummies_xptr)
}
